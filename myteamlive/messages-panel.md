...
During a broadcast, use the Messages panel to trigger custom messages, Celly Stickers, and branding.
...
## Using Stream Logos
Stream Logos are persistent and stay visible in the bottom-right corner until you remove them.

1. Tap a Stream logo in the Messages panel to display it immediately.
2. The logo remains on screen until you tap it again to dismiss it.
3. Only one logo can be active at a time—tapping a new logo  replaces the current one.
...
- Stream Logos work well for sponsor or team branding that should stay visible throughout the broadcast.
