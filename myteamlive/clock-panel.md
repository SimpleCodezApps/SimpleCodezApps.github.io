...
The Game Clock runs down to 0. If you reset the Game Clock and there are active penalties, use *Save & Adjust Penalties* to keep the penalties in sync with the Game Clock.

## Penalties
List of active penalties, penalties can be expired or edited.
